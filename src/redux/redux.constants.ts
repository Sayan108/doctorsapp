...
//   upcomingAppointment: {data: IAppointment | null; loading: boolean; error: any};
...
// ];
export const doctorId = '349e3b14-54a5-463b-81e4-276d6508fe37';

export const headerText = ['Home', 'Appoinment list', 'Clinic list'];
